...
public class Seeds_Frag extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        list.add(new RecipeModel(R.drawable.img_15, "Wheat", "4000"));
        list.add(new RecipeModel(R.drawable.img_16, "Corn", "2800"));
        list.add(new RecipeModel(R.drawable.img_17, "pearl millet", "3000"));
        list.add(new RecipeModel(R.drawable.img_18, "Rice", "4500"));
        list.add(new RecipeModel(R.drawable.img_19, "Cotton", "3400"));
        list.add(new RecipeModel(R.drawable.img_20, "Beans", "2200"));
        list.add(new RecipeModel(R.drawable.img_21, "Mustard", "1500"));
